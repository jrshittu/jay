        ...
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          >
            <div className="relative">
              <Logo size="sm" />
              <Sparkles className="absolute -top-1 -right-1 w-4 h-4 text-orange-500 group-hover:text-yellow-500 transition-colors" />
            </div>
            <span className="text-2xl sm:text-3xl font-black tracking-tight logo-font">
              <span className="relative inline-block">
                <span className="absolute inset-0 bg-gradient-to-r from-amber-400 via-orange-500 to-rose-500 blur-lg opacity-40 group-hover:opacity-60 transition-opacity"></span>
              ...
              <span className="ml-1 text-orange-500 text-xs sm:text-sm font-semibold align-super">™</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-4">
            <Link to={ROUTES.LOGIN}>
              <Button
                variant="ghost"
                className="text-sm lg:text-base text-gray-700 hover:text-orange-600 hover:bg-orange-50 font-semibold transition-all duration-300"
              >
                Login
              </Button>
            </Link>
