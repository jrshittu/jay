...
export const IMAGES = {
  hero: "/vibrant-online-marketplace-with-people-shopping-an.jpg",
  shop: "../assets/shop.jpg",
  buyer: "../assets/buyer.jpg",
  shopper: "../assets/shopper.jpg",
  cart: "../assets/cart.jpg",
  rider: "/delivery-rider-on-motorcycle-carrying-packages.jpg",
} as const
